					...
					?>
						...
						if ( have_posts() ) :
							...
							<?php 
								...
								if ($_GET['max_square'] == '' or (int)$_GET['max_square'] == 0) $_GET['max_square'] = 20000;
								if(get_field('total_area') >= (int)$_GET['min_square'] and get_field('total_area') <= (int)$_GET['max_square']):
							 ?>

...
function mythem_scripts_styles(){ 
	...
	/*wp_enqueue_script( 'mythem-navigation1',  '/wp-content/themes/4U/jscripts/perfect-scrollbar.jquery.min.js', array(), '1.0', true );
	wp_enqueue_script( 'mythem-navigation2',  '/wp-content/themes/4U/jscripts/slick.min.js', array(), '1.0', true );
	wp_enqueue_script( 'mythem-navigation3',  '/wp-content/themes/4U/jscripts/ion.rangeSlider.min.js', array(), '1.0', true );
	wp_enqueue_script( 'mythem-navigation4',  '/wp-content/themes/4U/jscripts/jquery.countdown.js', array(), '1.0', true );
	wp_enqueue_script( 'mythem-navigation5',  '/wp-content/themes/4U/jscripts/count_ini_date.js', array(), '1.0', true );
	wp_enqueue_script( 'mythem-navigation6',  '/wp-content/themes/4U/jscripts/jquery.circliful.min.js', array(), '1.0', true );
	wp_enqueue_script( 'mythem-navigation7',  '/wp-content/themes/4U/jscripts/main.js', array(), '1.0', true );
	wp_enqueue_script( 'mythem-navigation8',  '/wp-content/themes/4U/jscripts/jquery.maskedinput.min.js', array(), '1.0', true );
	wp_enqueue_script( 'mythem-navigation9',  '/wp-content/themes/4U/jscripts/formCheck.js', array(), '1.0', true );
	wp_enqueue_script( 'mythem-navigation10',  'https://maps.googleapis.com/maps/api/js?key=AIzaSyA9_1_JXs2QclxvVJNIObd01p9tBeuek44&callback=cornerMapInit', array(), '1.0', true );
	wp_enqueue_script( 'mythem-navigation11',  'https://cdn.rawgit.com/googlemaps/v3-utility-library/master/markerwithlabel/src/markerwithlabel.js', array(), '1.0', true );
 */
...
function do_something_callback(){
    ...
    $to      = 'little_cat1@ukr.net, murashenkorb@gmail.com';
